...
namespace Products
{
    public class StoreProducts
    {
        ...
        public static Product bananas => new Product(90, "item_bananas");
        public static Product apples => new Product(120, "item_apples");
        public static Product pears => new Product(200, "item_pears");
        public static Product orange => new Product(130, "item_orange");
        public static Product cucumbers => new Product(160, "item_cucumbers");
        public static Product tomatoes => new Product(200, "item_tomatoes");
        public static Product pepper => new Product(350, "item_pepper");
